...
unsigned long myChannelNumber =  2750438;
const int ChannelField = 1; 
const char * myWriteAPIKey = "IYEZF46J4T8V0KLE";
...
```
# CIRCUIT DIAGRAM:
![image](https://github.com/user-attachments/assets/3e8fbf63-9467-4d3b-a4af-8c5add7dc1f8)

# OUTPUT:
![image](https://github.com/user-attachments/assets/fff8b4a5-6856-4742-8333-207accdcd2a4)
